...
// fn normalize_local_links_to_virtual_paths(
...
//         let attributes = ["href", "src", "poster"];
//         for key in attributes {
//             if let Some(src_value) = attrs.get(key) {
//                 let source = input.source_path.clone();
//                 let target = PathBuf::from(src_value);
//                 ctx.dependencies.insert(Dependency { origin: source, target, is_internal: false });
//                 // - -
...
//                     &input.project_root,
//                 );
//                 attrs.insert(String::from(key), virtual_src);
//             }
//         }
//         Html::Element(Element { tag: tag.into(), attrs: attrs, children: children })
//     })
// }
...
//             }
//         }
//         Html::Element(Element { tag: String::from("video"), attrs: attrs, children: children })
//     })
// }
...
//             let new_dependency = Dependency { origin, target, is_internal: false };
